---
title: Overview
source: https://doc.babylonjs.com/lite/architecture/00-overview/
...
[Overview](https://doc.babylonjs.com/lite/architecture/00-overview/)
...
- [Architecture](https://doc.babylonjs.com/lite/architecture/00-overview/)
  ...
  - [Animation](https://doc.babylonjs.com/lite/architecture/07-animation/)
  ...
  - [Vertex Animation Texture](https://doc.babylonjs.com/lite/architecture/15-vertex-animation-texture/)
  ...
  - [Loader HDR](https://doc.babylonjs.com/lite/architecture/19-loader-hdr/)
  ...
  - [Post Process](https://doc.babylonjs.com/lite/architecture/29-post-process/)

  - [Effect Renderer](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/)

  - [Geometry Renderer](https://doc.babylonjs.com/lite/architecture/31-geometry-renderer/)

  - [Sprites](https://doc.babylonjs.com/lite/architecture/32-sprites/)

  - [Text](https://doc.babylonjs.com/lite/architecture/33-text/)
  ...
  - [Audio Engine](https://doc.babylonjs.com/lite/architecture/41-audio-engine/)
...
[Babylon Lite — Architecture Specification (One-Shot Document)](https://doc.babylonjs.com/lite/architecture/00-overview/#babylon-lite--architecture-specification-one-shot-document) [Architecture Document Index](https://doc.babylonjs.com/lite/architecture/00-overview/#architecture-document-index) [1\. Repository Structure](https://doc.babylonjs.com/lite/architecture/00-overview/#1-repository-structure) [2\. Public API Surface](https://doc.babylonjs.com/lite/architecture/00-overview/#2-public-api-surface) [Functions](https://doc.babylonjs.com/lite/architecture/00-overview/#functions) [Types](https://doc.babylonjs.com/lite/architecture/00-overview/#types) [3\. Module Specifications](https://doc.babylonjs.com/lite/architecture/00-overview/#3-module-specifications) [3.1 Core Math (`math/`)](https://doc.babylonjs.com/lite/architecture/00-overview/#31-core-math-math) [3.2 Engine (`engine/engine.ts`)](https://doc.babylonjs.com/lite/architecture/00-overview/#32-engine-engineenginets) [3.3 Scene (`scene/scene.ts`)](https://doc.babylonjs.com/lite/architecture/00-overview/#33-scene-scenescenets) [3.4 Camera (`camera/arc-rotate.ts`)](https://doc.babylonjs.com/lite/architecture/00-overview/#34-camera-cameraarc-rotatets) [3.5 Light (`light/hemispheric.ts`)](https://doc.babylonjs.com/lite/architecture/00-overview/#35-light-lighthemisphericts) [3.6 Materials (`material/pbr/`, `material/standard/`)](https://doc.babylonjs.com/lite/architecture/00-overview/#36-materials-materialpbr-materialstandard) [3.7 Renderable Architecture (`render/renderable.ts`)](https://doc.babylonjs.com/lite/architecture/00-overview/#37-renderable-architecture-renderrenderablets) [3.8 glTF Loader (`loader-gltf/load-gltf.ts`)](https://doc.babylonjs.com/lite/architecture/00-overview/#38-gltf-loader-loader-gltfload-gltfts) [3.9 Environment Loader (`loader-env/load-env.ts`)](https://doc.babylonjs.com/lite/architecture/00-overview/#39-environment-loader-loader-envload-envts) [3.10 Shaders](https://doc.babylonjs.com/lite/architecture/00-overview/#310-shaders) [Scene Uniforms (shared struct)](https://doc.babylonjs.com/lite/architecture/00-overview/#scene-uniforms-shared-struct) [PBR Vertex Shader (composed by `composePbrVertex`)](https://doc.babylonjs.com/lite/architecture/00-overview/#pbr-vertex-shader-composed-by-composepbrvertex) [PBR Fragment Shader (composed by `composePbrFragment`)](https://doc.babylonjs.com/lite/architecture/00-overview/#pbr-fragment-shader-composed-by-composepbrfragment) [4\. Scene 1 Rendering Spec (from Spector.GPU Capture)](https://doc.babylonjs.com/lite/architecture/00-overview/#4-scene-1-rendering-spec-from-spectorgpu-capture) [Render Pass Configuration](https://doc.babylonjs.com/lite/architecture/00-overview/#render-pass-configuration) [Draw Call 1: BoomBox](https://doc.babylonjs.com/lite/architecture/00-overview/#draw-call-1-boombox) [Draw Call 2: Ground Plane](https://doc.babylonjs.com/lite/architecture/00-overview/#draw-call-2-ground-plane) [Draw Call 3: Skybox](https://doc.babylonjs.com/lite/architecture/00-overview/#draw-call-3-skybox) [Textures (10 total)](https://doc.babylonjs.com/lite/architecture/00-overview/#textures-10-total) [Camera](https://doc.babylonjs.com/lite/architecture/00-overview/#camera) [Light](https://doc.babylonjs.com/lite/architecture/00-overview/#light) [5\. Data Flow Diagram](https://doc.babylonjs.com/lite/architecture/00-overview/#5-data-flow-diagram) [6\. Babylon.js Equivalence Map](https://doc.babylonjs.com/lite/architecture/00-overview/#6-babylonjs-equivalence-map) [7\. Build & Dev Configuration](https://doc.babylonjs.com/lite/architecture/00-overview/#7-build--dev-configuration) [TypeScript (`tsconfig.base.json`)](https://doc.babylonjs.com/lite/architecture/00-overview/#typescript-tsconfigbasejson) [Vite (engine lib build)](https://doc.babylonjs.com/lite/architecture/00-overview/#vite-engine-lib-build) [Package resolution](https://doc.babylonjs.com/lite/architecture/00-overview/#package-resolution) [8\. Test Specification](https://doc.babylonjs.com/lite/architecture/00-overview/#8-test-specification) [Unit Tests (per module)](https://doc.babylonjs.com/lite/architecture/00-overview/#unit-tests-per-module) [Integration Tests (Playwright + pixel diff)](https://doc.babylonjs.com/lite/architecture/00-overview/#integration-tests-playwright--pixel-diff) [Regression](https://doc.babylonjs.com/lite/architecture/00-overview/#regression) [9\. Known Limitations](https://doc.babylonjs.com/lite/architecture/00-overview/#9-known-limitations) [10\. File Manifest](https://doc.babylonjs.com/lite/architecture/00-overview/#10-file-manifest)
...
> Material Variants (KHR\_materials\_variants), CSG/CSG2, FlightHelmetKTX via `KHR_texture_basisu`,
...
| Doc | Module | Scope |
| --- | --- | --- |
| Doc<br> [00-overview.md](https://doc.babylonjs.com/lite/architecture/00-overview) | Module<br>Overview | Scope<br>Repository structure, public API |
| Doc<br> [01-scene.md](https://doc.babylonjs.com/lite/architecture/01-scene) | Module<br>Scene | Scope<br>SceneContext, one-way ownership |
| Doc<br> [02-camera.md](https://doc.babylonjs.com/lite/architecture/02-camera) | Module<br>Camera | Scope<br>ArcRotateCamera + FreeCamera, controls |
| Doc<br> [03-lights.md](https://doc.babylonjs.com/lite/architecture/03-lights) | Module<br>Lights | Scope<br>Hemispheric, directional, point, spot + shared lights UBO for Standard/PBR |
| Doc<br> [04-loaders.md](https://doc.babylonjs.com/lite/architecture/04-loaders) | Module<br>Loaders | Scope<br>glTF 2.0, dynamic glTF features, .env, .hdr, .babylon, skybox, Gaussian splats |
| Doc<br> [05-background-skybox.md](https://doc.babylonjs.com/lite/architecture/05-background-skybox) | Module<br>Background/Skybox | Scope<br>DDS/HDR/cubemap skybox, ground, background material |
| Doc<br> [06-pbr-material.md](https://doc.babylonjs.com/lite/architecture/06-pbr-material) | Module<br>PBR Material | Scope<br>ShaderFragment composition, GGX/IBL, clearcoat, sheen |
| Doc<br> [07-animation.md](https://doc.babylonjs.com/lite/architecture/07-animation) | Module<br>Animation | Scope<br>AnimationGroup, keyframe evaluation, glTF integration |
| Doc<br> [08-standard-material.md](https://doc.babylonjs.com/lite/architecture/08-standard-material) | Module<br>Standard Material | Scope<br>ShaderFragment composition, Blinn-Phong |
| Doc<br> [09-texture-2d.md](https://doc.babylonjs.com/lite/architecture/09-texture-2d) | Module<br>Texture2D | Scope<br>Image upload, KTX1/KTX2, mipmap gen, invertY |
| Doc<br> [10-mesh-generators.md](https://doc.babylonjs.com/lite/architecture/10-mesh-generators) | Module<br>Mesh Generators | Scope<br>Ground/heightmap, torus, sphere, box, cylinder, plane, disc, polyhedron, ribbon, tube, extrude |
| Doc<br> [11-scene-hierarchy-parenting.md](https://doc.babylonjs.com/lite/architecture/11-scene-hierarchy-parenting) | Module<br>Scene Hierarchy | Scope<br>TransformNode, parenting, world matrix propagation |
| Doc<br> [12-thin-instances.md](https://doc.babylonjs.com/lite/architecture/12-thin-instances) | Module<br>Thin Instances | Scope<br>Per-instance matrix + color, PBR + Standard |
| Doc<br> [13-skeleton.md](https://doc.babylonjs.com/lite/architecture/13-skeleton) | Module<br>Skeleton | Scope<br>Bone textures, 4/8-bone skinning |
| Doc<br> [14-morph-targets.md](https://doc.babylonjs.com/lite/architecture/14-morph-targets) | Module<br>Morph Targets | Scope<br>Vertex extension, GPU texture weights |
| Doc<br> [15-vertex-animation-texture.md](https://doc.babylonjs.com/lite/architecture/15-vertex-animation-texture) | Module<br>Vertex Animation Texture | Scope<br>VAT baking, texture-based skinning, per-instance + dual-clip-blend instancing, shadow casting |
| Doc<br> [16-shadow-generator.md](https://doc.babylonjs.com/lite/architecture/16-shadow-generator) | Module<br>Shadow Generator | Scope<br>ESM + PCF shadows, depth pass, Gaussian blur |
| Doc<br> [17-cascaded-shadow.md](https://doc.babylonjs.com/lite/architecture/17-cascaded-shadow) | Module<br>Cascaded Shadow Maps | Scope<br>Directional CSM: frustum splits, per-cascade ortho fit, depth array, PCF5 receiver |
| Doc<br> [18-picking.md](https://doc.babylonjs.com/lite/architecture/18-picking) | Module<br>Picking | Scope<br>GPU ID pass, CPU ray/triangle intersection |
| Doc<br> [19-loader-hdr.md](https://doc.babylonjs.com/lite/architecture/19-loader-hdr) | Module<br>HDR Loader | Scope<br>RGBE parsing, SH extraction, GPU compute IBL |
| Doc<br> [20-loader-babylon.md](https://doc.babylonjs.com/lite/architecture/20-loader-babylon) | Module<br>.babylon Loader | Scope<br>.babylon format parsing |
| Doc<br> [21-core-math.md](https://doc.babylonjs.com/lite/architecture/21-core-math) | Module<br>Core Math | Scope<br>Vec3, Mat4, Quat, ObservableVec3/Quat |
| Doc<br> [22-engine.md](https://doc.babylonjs.com/lite/architecture/22-engine) | Module<br>Engine | Scope<br>GPU init, MSAA, render loop, swap chain |
| Doc<br> [23-shader-composition.md](https://doc.babylonjs.com/lite/architecture/23-shader-composition) | Module<br>Shader Composition | Scope<br>ShaderFragment system, composer, slot injection |
| Doc<br> [24-shader-material.md](https://doc.babylonjs.com/lite/architecture/24-shader-material) | Module<br>Shader Material | Scope<br>WGSL-only ShaderMaterial: typed uniforms, samplers, defines, alpha blend/test |
| Doc<br> [25-grid-material.md](https://doc.babylonjs.com/lite/architecture/25-grid-material) | Module<br>Grid Material | Scope<br>Procedural unlit object-space grid built on ShaderMaterial |
| Doc<br> [26-material-plugin.md](https://doc.babylonjs.com/lite/architecture/26-material-plugin) | Module<br>Material Plugin | Scope<br>Opt-in PBR/Standard material plugins, self-registration, zero-impact extension seam |
| Doc<br> [27-render-pipeline.md](https://doc.babylonjs.com/lite/architecture/27-render-pipeline) | Module<br>Renderable Architecture | Scope<br>Renderable interfaces, entity-owned pipelines |
| Doc<br> [28-frame-graph.md](https://doc.babylonjs.com/lite/architecture/28-frame-graph) | Module<br>Frame Graph | Scope<br>Task ordering, RenderTask, passes, render targets, RTT texture flow |
| Doc<br> [29-post-process.md](https://doc.babylonjs.com/lite/architecture/29-post-process) | Module<br>Post Process | Scope<br>Frame-graph fullscreen post-process helper and concrete post-process tasks |
| Doc<br> [30-effect-renderer.md](https://doc.babylonjs.com/lite/architecture/30-effect-renderer) | Module<br>Effect Renderer | Scope<br>EffectRenderer/EffectWrapper, fullscreen passes, RTT output, texture bindings |
| Doc<br> [31-geometry-renderer.md](https://doc.babylonjs.com/lite/architecture/31-geometry-renderer) | Module<br>Geometry Renderer | Scope<br>Frame-graph normal/depth/position G-buffer textures |
| Doc<br> [32-sprites.md](https://doc.babylonjs.com/lite/architecture/32-sprites) | Module<br>Sprites | Scope<br>2D sprites, depth-hosted sprites, sprite renderables |
| Doc<br> [33-text.md](https://doc.babylonjs.com/lite/architecture/33-text) | Module<br>Text | Scope<br>Slug GPU font: GlyphStorage + TextData + TextRenderable (3D) / TextRenderer (2D) + defaults |
| Doc<br> [34-geospatial-camera.md](https://doc.babylonjs.com/lite/architecture/34-geospatial-camera) | Module<br>Geospatial Camera | Scope<br>Globe-orbit camera (center/yaw/pitch/radius) with fly-to + controls |
| Doc<br> [35-large-world-rendering.md](https://doc.babylonjs.com/lite/architecture/35-large-world-rendering) | Module<br>LWR / Floating Origin | Scope<br>`useFloatingOrigin` engine flag, eye-relative upload, FO version tracking |
| Doc<br> [36-high-precision-matrix.md](https://doc.babylonjs.com/lite/architecture/36-high-precision-matrix) | Module<br>High-Precision Matrix | Scope<br>`useHighPrecisionMatrix` engine flag, F64 backing, `allocateMat4` singleton, `packMat4IntoF32` |
| Doc<br> [37-resource-pool.md](https://doc.babylonjs.com/lite/architecture/37-resource-pool) | Module<br>Resource Pool | Scope<br>GPU buffer/texture pooling |
| Doc<br> [38-bundle-size-tooling.md](https://doc.babylonjs.com/lite/architecture/38-bundle-size-tooling) | Module<br>Bundle Size Tooling | Scope<br>Per-scene bundle analysis, ceilings, treemaps |
| Doc<br> [39-animation-parity-testing.md](https://doc.babylonjs.com/lite/architecture/39-animation-parity-testing) | Module<br>Animation Parity | Scope<br>Animated scene test methodology |
| Doc<br> [40-material-stencil.md](https://doc.babylonjs.com/lite/architecture/40-material-stencil) | Module<br>Material Stencil | Scope<br>Opt-in `enableMaterialStencil` per-material stencil mask/test on Standard/PBR/Shader, zero-impact hook |
| Doc<br> [41-audio-engine.md](https://doc.babylonjs.com/lite/architecture/41-audio-engine) | Module<br>Audio Engine | Scope<br>Web Audio playback, buses, 3D spatial, panning, analyser, microphone, unmute UI |
| Doc<br> [42-physics.md](https://doc.babylonjs.com/lite/architecture/42-physics) | Module<br>Physics | Scope<br>Havok V2 world, bodies/shapes/aggregates, timestep & delta propagation, collision/trigger/query/character |
| Doc<br> [49-error-handling.md](https://doc.babylonjs.com/lite/architecture/49-error-handling) | Module<br>Error Handling | Scope<br>Coded errors by default; `enableErrorDecoding` (always-on) vs `decodeError` (on-the-fly, e.g. telemetry) |
| Doc<br> [50-device-lost-recovery.md](https://doc.babylonjs.com/lite/architecture/50-device-lost-recovery) | Module<br>Device Lost Recovery | Scope<br>Opt-in Scene, SpriteRenderer, and TextRenderer recovery after WebGPU device loss |
| Doc<br> [51-flow-graph.md](https://doc.babylonjs.com/lite/architecture/51-flow-graph) | Module<br>Flow Graph | Scope<br>Pure-state visual scripting, stable glTF `KHR_interactivity`, and editor JSON compatibility |
...
> see the generated TypeDoc site: **< [https://doc.babylonjs.com/lite/typedoc](https://doc.babylonjs.com/lite/typedoc) >**.
...
| --- | --- | --- |
| Function<br>`mat4Identity()` | Signature<br>`→ Mat4` | Notes<br>16-float identity |
| Function<br>`mat4Multiply(a, b)` | Signature<br>`→ Mat4` | Notes<br>Column-major `a * b` |
| Function<br>`mat4LookAtLH(eye, target, up)` | Signature<br>`→ Mat4` | Notes<br>LH look-at, `zAxis = normalize(target - eye)` |
| Function<br>`mat4PerspectiveLH(fov, aspect, near, far)` | Signature<br>`→ Mat4` | Notes<br>Zero-to-one depth, `tan = 1/tan(fov/2)` |
| Function<br>`mat4Invert(m)` | Signature<br>`→ Mat4 | null` | Notes<br>Full 4x4 inverse via cofactors |
| Function<br>`mat4Compose(tx,ty,tz, qx,qy,qz,qw, sx,sy,sz)` | Signature<br>`→ Mat4` | Notes<br>TRS composition |
| Function<br>`mat4FromQuat(qx,qy,qz,qw)` | Signature<br>`→ Mat4` | Notes<br>Quaternion to rotation matrix |
| Function<br>`mat4FromQuatInto(out, qx,qy,qz,qw)` | Signature<br>`→ out` | Notes<br>Zero-allocation quaternion to rotation matrix |
...
**Component types**: FLOAT=5126, UNSIGNED\_SHORT=5123, UNSIGNED\_INT=5125, UNSIGNED\_BYTE=5121
...
5. Resolve accessors: POSITION, NORMAL, TANGENT, TEXCOORD\_0, indices
...
**Inputs**: position (loc 0, f32x3), normal (loc 1, f32x3), tangent (loc 2, f32x4, if HAS\_NORMAL\_MAP), uv (loc 2 or 3, f32x2)
...
| --- | --- | --- |
| Babylon.js<br>`new Engine(canvas)` | Babylon Lite<br>`createEngine(canvas)` | Notes<br>Async, returns Promise |
| Babylon.js<br>`new Scene(engine)` | Babylon Lite<br>`createSceneContext(engine)` | Notes<br>Flat struct, no observables |
| Babylon.js<br>`SceneLoader.Append(url)` | Babylon Lite<br>`addToScene(scene, await loadGltf(engine, url))` | Notes<br>glTF/GLB with scoped extension modules |
| Babylon.js<br>`scene.createDefaultEnvironment()` | Babylon Lite<br>`loadEnvironment(scene, url)` | Notes<br>Explicit URL |
| Babylon.js<br>`scene.createDefaultCameraOrLight()` | Babylon Lite<br>`createDefaultCamera(scene)` \+ `createHemisphericLight()` | Notes<br>Separate functions |
| Babylon.js<br>`new HemisphericLight(...)` | Babylon Lite<br>`createHemisphericLight(dir, intensity)` | Notes<br>Returns plain data |
| Babylon.js<br>`new ArcRotateCamera(...)` | Babylon Lite<br>`createDefaultCamera(scene)` | Notes<br>Auto-frames, returns data |
| Babylon.js<br>`PBRMaterial` | Babylon Lite<br>`getOrCreatePbrPipeline()` \+ composer | Notes<br>Feature-flag pipelines |
| Babylon.js<br>`StandardMaterial` | Babylon Lite<br>`getOrCreatePipeline()` \+ composer | Notes<br>Feature-flag pipelines |
| Babylon.js<br>`scene._prepareFrame()` | Babylon Lite<br>`startEngine()` runs deferred builders | Notes<br>Lazy pipeline creation |
| Babylon.js<br>`engine.runRenderLoop(...)` | Babylon Lite<br>`registerScene(scene)` \+ `startEngine(engine)` | Notes<br>One or more registered rendering contexts |
...
| --- | --- | --- |
| File<br>`src/index.ts` | Purpose<br>Public API barrel | Lines (approx)<br>95 |
| File<br>`src/math/types.ts` | Purpose<br>Math type definitions | Lines (approx)<br>45 |
| File<br>`src/math/vec3.ts` | Purpose<br>Vec3 pure functions | Lines (approx)<br>68 |
| File<br>`src/math/mat4.ts` | Purpose<br>Mat4 pure functions | Lines (approx)<br>185 |
| File<br>`src/math/observable-vec3.ts` | Purpose<br>Reactive Vec3 (position/target) | Lines (approx)<br>— |
| File<br>`src/math/observable-quat.ts` | Purpose<br>Reactive Quat (rotation) | Lines (approx)<br>— |
| File<br>`src/engine/engine.ts` | Purpose<br>WebGPU device + render loop | Lines (approx)<br>150 |
| File<br>`src/scene/scene.ts` | Purpose<br>Scene context struct + add() | Lines (approx)<br>130 |
| File<br>`src/scene/scene-core.ts` | Purpose<br>Core scene logic | Lines (approx)<br>— |
| File<br>`src/scene/scene-camera.ts` | Purpose<br>Camera management | Lines (approx)<br>— |
| File<br>`src/scene/scene-remove.ts` | Purpose<br>removeFromScene() | Lines (approx)<br>— |
| File<br>`src/scene/set-parent.ts` | Purpose<br>setParent() — parent/child transforms | Lines (approx)<br>— |
| File<br>`src/scene/parentable.ts` | Purpose<br>IWorldMatrixProvider, IParentable | Lines (approx)<br>— |
| File<br>`src/scene/transform-node.ts` | Purpose<br>TransformNode factory + collectMeshes | Lines (approx)<br>— |
| File<br>`src/scene/world-matrix-state.ts` | Purpose<br>Version-based world matrix propagation | Lines (approx)<br>— |
| File<br>`src/camera/camera.ts` | Purpose<br>Camera interface | Lines (approx)<br>— |
| File<br>`src/camera/arc-rotate.ts` | Purpose<br>ArcRotateCamera | Lines (approx)<br>85 |
| File<br>`src/camera/arc-rotate-controls.ts` | Purpose<br>Orbit controls | Lines (approx)<br>70 |
| File<br>`src/camera/free-camera.ts` | Purpose<br>FreeCamera | Lines (approx)<br>— |
| File<br>`src/camera/free-camera-controls.ts` | Purpose<br>WASD/arrow controls | Lines (approx)<br>— |
| File<br>`src/light/light-base.ts` | Purpose<br>Shared light base | Lines (approx)<br>— |
| File<br>`src/light/types.ts` | Purpose<br>LightBase type, LightBaseInternal, MAX\_LIGHTS | Lines (approx)<br>— |
| File<br>`src/light/light-matrix.ts` | Purpose<br>Light view-projection for shadows | Lines (approx)<br>— |
| File<br>`src/light/hemispheric.ts` | Purpose<br>Hemispheric light factory | Lines (approx)<br>16 |
| File<br>`src/light/point-light.ts` | Purpose<br>Point light factory | Lines (approx)<br>20 |
| File<br>`src/light/directional-light.ts` | Purpose<br>Directional light factory | Lines (approx)<br>20 |
| File<br>`src/light/spot-light.ts` | Purpose<br>Spot light factory | Lines (approx)<br>— |
| File<br>`src/material/pbr/pbr-material.ts` | Purpose<br>PBR material props + factory | Lines (approx)<br>25 |
| File<br>`src/material/pbr/pbr-template.ts` | Purpose<br>PBR shader template (WGSL gen) | Lines (approx)<br>230 |
| File<br>`src/material/pbr/pbr-flags.ts` | Purpose<br>PBR feature flag bitmask | Lines (approx)<br>— |
| File<br>`src/material/pbr/pbr-pipeline.ts` | Purpose<br>PBR pipeline cache | Lines (approx)<br>170 |
| File<br>`src/material/pbr/pbr-renderable.ts` | Purpose<br>PBR renderable builder + single-mesh rebuild closure | Lines (approx)<br>140 |
| File<br>`src/material/pbr/no-color-view.ts` | Purpose<br>PBR no-color material view helper | Lines (approx)<br>— |
| File<br>`src/material/pbr/fragments/singlelight-wgsl.ts` | Purpose<br>Non-looping single-light PBR WGSL | Lines (approx)<br>— |
| File<br>`src/material/pbr/fragments/multilight-wgsl.ts` | Purpose<br>Generic multi-light PBR WGSL | Lines (approx)<br>— |
| File<br>`src/material/pbr/background-material.ts` | Purpose<br>Skybox + Ground material factories | Lines (approx)<br>217 |
| File<br>`src/material/pbr/background-renderable.ts` | Purpose<br>Background renderable builder | Lines (approx)<br>96 |
| File<br>`src/material/pbr/background-dds-skybox.ts` | Purpose<br>DDS environment skybox | Lines (approx)<br>— |
| File<br>`src/material/pbr/background-hdr-skybox.ts` | Purpose<br>HDR environment skybox | Lines (approx)<br>— |
| File<br>`src/material/pbr/background-ground.ts` | Purpose<br>Background ground plane | Lines (approx)<br>— |
| File<br>`src/material/pbr/fragments/` | Purpose<br>PBR ShaderFragment modules | Lines (approx)<br>— |
| File<br>`src/material/standard/standard-material.ts` | Purpose<br>Standard types + factory | Lines (approx)<br>93 |
| File<br>`src/material/standard/standard-template.ts` | Purpose<br>Standard shader template (WGSL gen) | Lines (approx)<br>230 |
| File<br>`src/material/standard/standard-pipeline.ts` | Purpose<br>Standard pipeline cache | Lines (approx)<br>280 |
| File<br>`src/material/standard/standard-renderable.ts` | Purpose<br>Standard renderable builder + single-mesh rebuild closure | Lines (approx)<br>115 |
| File<br>`src/material/standard/no-color-view.ts` | Purpose<br>Standard no-color material view helper | Lines (approx)<br>— |
| File<br>`src/material/standard/skybox-cubemap.ts` | Purpose<br>CubeMap skybox pipeline | Lines (approx)<br>104 |
| File<br>`src/material/standard/fragments/` | Purpose<br>Standard ShaderFragment modules | Lines (approx)<br>— |
| File<br>`src/material/grid/grid-material.ts` | Purpose<br>GridMaterial factory + options (composes WGSL on ShaderMaterial) | Lines (approx)<br>— |
| File<br>`src/shader/shader-composer.ts` | Purpose<br>ShaderFragment composer engine | Lines (approx)<br>— |
| File<br>`src/shader/fragment-types.ts` | Purpose<br>ShaderFragment interface definitions | Lines (approx)<br>— |
| File<br>`src/shader/ubo-layout.ts` | Purpose<br>UBO layout helpers | Lines (approx)<br>— |
| File<br>`src/shader/wgsl-helpers.ts` | Purpose<br>WGSL code-gen utilities | Lines (approx)<br>— |
| File<br>`src/render/renderable.ts` | Purpose<br>Renderable/PrePass/Updater interfaces | Lines (approx)<br>20 |
| File<br>`src/render/scene-helpers.ts` | Purpose<br>Shared helper utilities | Lines (approx)<br>— |
| File<br>`src/render/lights-ubo.ts` | Purpose<br>Multi-light UBO packing | Lines (approx)<br>— |
| File<br>`src/mesh/mesh.ts` | Purpose<br>Mesh type and GPU upload | Lines (approx)<br>80 |
| File<br>`src/mesh/mesh-factories.ts` | Purpose<br>High-level mesh factories | Lines (approx)<br>50 |
| File<br>`src/mesh/thin-instance.ts` | Purpose<br>Thin instance CPU data + public API | Lines (approx)<br>— |
| File<br>`src/mesh/thin-instance-gpu.ts` | Purpose<br>Thin instance GPU sync | Lines (approx)<br>— |
| File<br>`src/skeleton/create-skeleton.ts` | Purpose<br>Skeleton data creation from glTF | Lines (approx)<br>— |
| File<br>`src/skeleton/skeleton-updater.ts` | Purpose<br>Joint matrix computation | Lines (approx)<br>— |
| File<br>`src/animation/animation-manager.ts` | Purpose<br>Generic AnimationTask scheduler | Lines (approx)<br>— |
| File<br>`src/animation/animation-group.ts` | Purpose<br>AnimationGroup state and playback helpers | Lines (approx)<br>— |
| File<br>`src/animation/animation-group-task.ts` | Purpose<br>AnimationGroup task adapter | Lines (approx)<br>— |
| File<br>`src/animation/property-animation.ts` | Purpose<br>User-authored property clips | Lines (approx)<br>— |
| File<br>`src/animation/evaluate.ts` | Purpose<br>Keyframe interpolation | Lines (approx)<br>— |
| File<br>`src/animation/types.ts` | Purpose<br>Animation type definitions | Lines (approx)<br>— |
| File<br>`src/morph/create-morph-targets.ts` | Purpose<br>Morph target data + GPU texture | Lines (approx)<br>— |
| File<br>`src/picking/gpu-picker.ts` | Purpose<br>GPU ID-pass picking | Lines (approx)<br>— |
| File<br>`src/picking/picking-pipeline.ts` | Purpose<br>Picking render pipeline | Lines (approx)<br>— |
| File<br>`src/picking/picking-shader.ts` | Purpose<br>Picking WGSL shaders | Lines (approx)<br>— |
| File<br>`src/picking/picking-helpers.ts` | Purpose<br>getPickedNormal(), getPickedUV() | Lines (approx)<br>— |
| File<br>`src/picking/picking-info.ts` | Purpose<br>PickingInfo type | Lines (approx)<br>— |
| File<br>`src/picking/detailed-picking.ts` | Purpose<br>CPU ray/triangle intersection | Lines (approx)<br>— |
| File<br>`src/picking/ray.ts` | Purpose<br>Ray intersection math | Lines (approx)<br>— |
| File<br>`src/resource/gpu-pool.ts` | Purpose<br>GPU buffer/texture pooling | Lines (approx)<br>— |
| File<br>`src/shadow/shadow-base.ts` | Purpose<br>Shared shadow logic | Lines (approx)<br>— |
| File<br>`src/shadow/shadow-generator.ts` | Purpose<br>ShadowGenerator contract | Lines (approx)<br>— |
| File<br>`src/shadow/esm-directional-shadow-generator.ts` | Purpose<br>Directional ESM shadow generator | Lines (approx)<br>150 |
| File<br>`src/shadow/pcf-spotlight-shadow-generator.ts` | Purpose<br>Spot PCF shadow generator | Lines (approx)<br>— |
| File<br>`src/shadow/pcf-directional-shadow-generator.ts` | Purpose<br>Directional PCF shadow generator | Lines (approx)<br>— |
| File<br>`src/frame-graph/task.ts` | Purpose<br>Frame-graph task interface | Lines (approx)<br>— |
| File<br>`src/frame-graph/frame-graph.ts` | Purpose<br>Ordered frame-graph task list | Lines (approx)<br>— |
| File<br>`src/frame-graph/frame-graph-actions.ts` | Purpose<br>Task insertion helpers | Lines (approx)<br>— |
| File<br>`src/frame-graph/render-pass-task.ts` | Purpose<br>Render-pass task, per-pass scene UBO, draw buckets | Lines (approx)<br>— |
| File<br>`src/texture/texture-2d.ts` | Purpose<br>2D texture loader | Lines (approx)<br>60 |
| File<br>`src/texture/solid-texture.ts` | Purpose<br>1×1 solid-color factory | Lines (approx)<br>— |
| File<br>`src/texture/cube-texture.ts` | Purpose<br>6-face cube texture loader | Lines (approx)<br>141 |
| File<br>`src/texture/rtt.ts` | Purpose<br>Render-target texture helper | Lines (approx)<br>— |
| File<br>`src/texture/ktx2-loader.ts` | Purpose<br>KTX2/BasisU upload for `KHR_texture_basisu` | Lines (approx)<br>— |
| File<br>`src/texture/mip-count.ts` | Purpose<br>Biased mip-count helper | Lines (approx)<br>— |
| File<br>`src/texture/generate-mipmaps.ts` | Purpose<br>GPU mipmap generation and encoder-local mipmap recording | Lines (approx)<br>— |
| File<br>`src/loader-gltf/load-gltf.ts` | Purpose<br>GLB parser + GPU upload | Lines (approx)<br>390 |
| File<br>`src/loader-gltf/gltf-parser.ts` | Purpose<br>glTF JSON parsing helpers | Lines (approx)<br>— |
| File<br>`src/loader-gltf/gltf-material.ts` | Purpose<br>glTF material → PbrMaterialProps | Lines (approx)<br>— |
| File<br>`src/loader-gltf/gltf-ext-basisu.ts` | Purpose<br>`KHR_texture_basisu` dynamic feature | Lines (approx)<br>— |
| File<br>`src/loader-gltf/gltf-interleave.ts` | Purpose<br>Native interleaved-VB support (lazy CPU de-stride) | Lines (approx)<br>— |
| File<br>`src/loader-gltf/gltf-feature-meshopt.ts` | Purpose<br>`EXT_meshopt_compression` dynamic feature | Lines (approx)<br>— |
| File<br>`src/loader-gltf/gltf-ext-quantization.ts` | Purpose<br>`KHR_mesh_quantization` dynamic feature | Lines (approx)<br>— |
| File<br>`src/loader-gltf/gltf-feature-xmp.ts` | Purpose<br>`KHR_xmp_json_ld` metadata dynamic feature | Lines (approx)<br>— |
| File<br>`src/loader-gltf/gltf-animation.ts` | Purpose<br>glTF animation extraction | Lines (approx)<br>— |
| File<br>`src/loader-env/load-env.ts` | Purpose<br>.env parser + RGBD decode | Lines (approx)<br>240 |
| File<br>`src/loader-env/load-dds-env.ts` | Purpose<br>DDS environment loading | Lines (approx)<br>— |
| File<br>`src/loader-env/env-helpers.ts` | Purpose<br>Environment helper utilities | Lines (approx)<br>— |
| File<br>`src/loader-env/rgbd-decode.ts` | Purpose<br>Shared RGBD decode helpers | Lines (approx)<br>— |
| File<br>`src/loader-hdr/load-hdr.ts` | Purpose<br>HDR environment pipeline | Lines (approx)<br>— |
| File<br>`src/loader-hdr/hdr-parser.ts` | Purpose<br>RGBE file parser | Lines (approx)<br>— |
| File<br>`src/loader-hdr/hdr-ibl-pipeline.ts` | Purpose<br>GPU compute IBL from HDR | Lines (approx)<br>— |
| File<br>`src/loader-babylon/load-babylon.ts` | Purpose<br>.babylon format parser | Lines (approx)<br>— |
| File<br>`src/loader-skybox/load-skybox.ts` | Purpose<br>High-level skybox loader | Lines (approx)<br>— |
| File<br>`src/loader-skybox/skybox-renderable.ts` | Purpose<br>Skybox → Renderable builder | Lines (approx)<br>— |
| File<br>`lab/lite/src/lite/scene1.ts` | Purpose<br>Scene 1: BoomBox PBR | Lines (approx)<br>44 |
| File<br>`lab/lite/src/lite/scene*.ts` | Purpose<br>Scenes 1–112 (dev sandbox) | Lines (approx)<br>— |
