---
title: Effect Renderer
source: https://doc.babylonjs.com/lite/architecture/30-effect-renderer/
...
[Module: Effect Renderer](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#module-effect-renderer) [Purpose](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#purpose) [Public API Surface (types, functions, constants — full signatures)](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#public-api-surface-types-functions-constants--full-signatures) [Internal Architecture (data structures, memory layouts)](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#internal-architecture-data-structures-memory-layouts) [Pipeline Configuration (vertex/fragment stages, bind groups, depth/stencil)](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#pipeline-configuration-vertexfragment-stages-bind-groups-depthstencil) [Shader Logic (WGSL outline or pseudocode with exact math)](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#shader-logic-wgsl-outline-or-pseudocode-with-exact-math) [State Machine / Lifecycle](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#state-machine--lifecycle) [Swapchain-only path (`EffectRenderer`)](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#swapchain-only-path-effectrenderer) [Offscreen RTT path (`createEffectRenderTask`)](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#offscreen-rtt-path-createeffectrendertask) [Uniform-only frame-graph path (`createUniformEffectRenderTask`)](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#uniform-only-frame-graph-path-createuniformeffectrendertask) [Babylon.js Equivalence Map](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#babylonjs-equivalence-map) [Dependencies](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#dependencies) [Test Specification](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#test-specification) [File Manifest](https://doc.babylonjs.com/lite/architecture/30-effect-renderer/#file-manifest)
...
| --- | --- |
| Babylon.js<br>`EffectWrapper` | Babylon Lite<br>`EffectWrapper` pure-state handle |
| Babylon.js<br>`EffectRenderer.render(wrapper)` (swapchain) | Babylon Lite<br>`createEffectRenderer(engine, effect)` \+ `registerEffectRenderer` — no scene needed |
| Babylon.js<br>`EffectRenderer.render(wrapper, outputTexture)` (RTT) | Babylon Lite<br>`createEffectRenderTask({ effect, target: rt })` scheduled in `FrameGraph` |
| Babylon.js<br>uniform-only fullscreen pass | Babylon Lite<br>`createUniformEffectWrapper` \+ `createUniformEffectRenderTask` |
| Babylon.js<br>fullscreen quad/index buffer | Babylon Lite<br>vertex-index fullscreen triangle |
| Babylon.js<br>`onApplyObservable` | Babylon Lite<br>user calls `setEffectUniforms` / `setEffectTexture` before the pass executes |
| Babylon.js<br>current framebuffer / RTT | Babylon Lite<br>direct `EffectRenderer` / frame-graph `RenderTarget` task |
| Babylon.js<br>`effect.setTexture("name", texture)` | Babylon Lite<br>`setEffectTexture(wrapper, "name", texture2D)` |
...
- `lab/public/thumbnails/scene74.jpg`
...
- `lab/public/thumbnails/scene75.jpg`
...
- `lab/public/thumbnails/scene76.jpg`
