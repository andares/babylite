---
title: Welcome
source: https://doc.babylonjs.com/lite/
section: Welcome
---
...
[Welcome](https://doc.babylonjs.com/lite/00-welcome/)
...
[Welcome to Babylon Lite](https://doc.babylonjs.com/lite/#welcome-to-babylon-lite) [TL;DR — Which engine should I use?](https://doc.babylonjs.com/lite/#tldr--which-engine-should-i-use) [What is Babylon Lite?](https://doc.babylonjs.com/lite/#what-is-babylon-lite) [Visually compatible — pixel-perfect with Babylon.js](https://doc.babylonjs.com/lite/#visually-compatible--pixel-perfect-with-babylonjs) [The numbers](https://doc.babylonjs.com/lite/#the-numbers) [Same scene, side by side](https://doc.babylonjs.com/lite/#same-scene-side-by-side) [The same scene in both engines](https://doc.babylonjs.com/lite/#the-same-scene-in-both-engines) [Babylon.js](https://doc.babylonjs.com/lite/#babylonjs) [Babylon Lite](https://doc.babylonjs.com/lite/#babylon-lite) [Choosing your engine](https://doc.babylonjs.com/lite/#choosing-your-engine) [In plain language](https://doc.babylonjs.com/lite/#in-plain-language) [Good to know](https://doc.babylonjs.com/lite/#good-to-know) [Frequently asked questions](https://doc.babylonjs.com/lite/#frequently-asked-questions) [What's next](https://doc.babylonjs.com/lite/#whats-next) [Next steps](https://doc.babylonjs.com/lite/#next-steps)
...
| If you want… | Choose |
| --- | --- |
| If you want…<br>The smallest possible bundle size, the highest performance, ship-only-what-you-use | Choose<br> **Babylon Lite** |
| If you want…<br>The broadest feature set, WebGL **and** WebGPU support, and rock-solid backward compatibility | Choose<br> **Babylon.js** |
| If you want…<br>To **learn 3D on the modern web** from a clean, classless API | Choose<br> **Babylon Lite** |
| If you want…<br>To ship a **production app today** that depends on the full Babylon feature set | Choose<br> **Babylon.js** |

Still unsure? Jump to the [decision tree](https://doc.babylonjs.com/lite/#choosing-your-engine) below.
...
| --- | --- |
| Metric<br> **Bundle size** (gzipped JS) | Babylon Lite vs Babylon.js<br> **~19× smaller** on average (~30× smaller uncompressed); up to **50× smaller** on focused scenes |
| Metric<br> **Frame time** (RAF CPU) | Babylon Lite vs Babylon.js<br> **~3–4× faster** |
| Metric<br> **Startup time** | Babylon Lite vs Babylon.js<br> **~2.5× faster** |
| Metric<br> **Memory** | Babylon Lite vs Babylon.js<br> **~5× less** |
| Metric<br> **Visual output** | Babylon Lite vs Babylon.js<br>Pixel-identical (median MAD 0.05) |
...
![Babylon Lite and Babylon.js rendering the identical BoomBox PBR scene side by side, annotated with bundle size and frame time](https://doc.babylonjs.com/lite/images/parity-side-by-side.png)
...
> Want to run this without installing anything? Paste it into the **[Lite Playground](https://liteplayground.babylonjs.com/)** and hit Run. See the **[Playground guide](https://doc.babylonjs.com/lite/04-playground)** for a tour.

> Ready to port a real scene? See the **[Porting Guide](https://doc.babylonjs.com/lite/03-porting-guide)** for a full side-by-side API map.
...
Yes — bringing Lite up toward Babylon.js feature parity is our top priority. Features land as isolated, tree-shakable modules, so the engine grows without bloating your bundle. See the **[Feature Comparison](https://doc.babylonjs.com/lite/02-feature-comparison)** for exactly what's covered today, what's partial, and what's still missing.
...
- 🛝 **[Lite Playground](https://doc.babylonjs.com/lite/04-playground)** — try Lite in your browser with zero setup: edit, run, and share snippets live.
- 🔁 **[Porting Guide](https://doc.babylonjs.com/lite/03-porting-guide)** — translate a Babylon.js scene to Babylon Lite, side by side.
- 📊 **[Feature Comparison](https://doc.babylonjs.com/lite/02-feature-comparison)** — the full Lite-vs-Babylon.js feature matrix, so you can see exactly what's covered, partial, or missing.
- 🧱 **[Architecture docs](https://doc.babylonjs.com/lite/architecture/00-overview)** — deep dives into the engine internals.
- 🧪 **[Headless (Null Engine)](https://doc.babylonjs.com/lite/05-headless-null-engine)** — run Lite without a GPU for server-side physics and deterministic simulation.
